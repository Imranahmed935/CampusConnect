    ...
    <div className="max-w-3xl mx-auto px-4 py-10">
      ...
      <div className="bg-white p-6 rounded-lg shadow-md mb-8">
        ...
        <div className="space-y-2">
          <p>
            <span className="font-medium">Name:</span> Imran Ahmed
          </p>
          <p>
            <span className="font-medium">Email:</span> imran@example.com
          </p>
          <p>
            <span className="font-medium">University:</span> Greenfield
            University
          </p>
          <p>
