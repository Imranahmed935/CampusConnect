    ...
    <div className="max-w-5xl mx-auto p-6 md:p-10 bg-white rounded-3xl mt-10">
      ...
      <div className="mt-8 space-y-4 text-gray-800">
        ...
        <div className="flex items-center gap-2">
          <p className="text-lg font-medium text-yellow-600">{college.rating} / 5</p>
          <div className="flex">
        ...
        <div className="grid md:grid-cols-2 gap-6 text-[17px]">
          ...
          <p><span className="font-semibold">📖 Research Papers:</span> {college.researchCount}</p>
        </div>

        {/* Description */}
        <div>
          <h2 className="text-xl font-semibold text-gray-700 mt-6">About</h2>
          <p className="mt-2 text-gray-600 leading-relaxed">{college.description}</p>
        </div>
